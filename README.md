...
- Normal CRM actions reuse the signed-in Microsoft session and token silently. If no session exists, the first action can ask you to sign in once. If the session is lost later, run `Dynamics 365 Tools: Sign In (Interactive)` again.
